                ...
                while i < len(CMD_fld):
                    ...
                    if 判定対象文字 == "'":
                        ...
                        while True:
                            ...
                            if (Mid(CMD_fld, 判定対象文字_to, 1) == "'"
                                    and Mid(CMD_fld, 判定対象文字_to + 1, 1) != "'"
                                    and apost_end) or 判定対象文字_to >= 72:
                                break
                    ...
                    # '「"」を区切で使うかどうか要確認（使わないのであれば↓は削除可）
                        ...
                        判定対象文字_to = Mid(CMD_fld, 判定対象文字_from + 1,
                                        len(CMD_fld)).find("\"")
                        ...
                        if 判定対象文字 == " ":
                            ...
                            if 判定対象文字2 == "'":
                                判定対象文字_to = Mid(CMD_fld, 判定対象文字_from + 2,
                                                len(CMD_fld)).find(判定対象文字2)
                                対象文字数 = 判定対象文字_to + 2 + 1
                            elif 判定対象文字2 == "\"":
                                判定対象文字_to = Mid(CMD_fld, 判定対象文字_from + 2,
                                                len(CMD_fld)).find(判定対象文字2)
                                ...
                                判定対象文字_to = Mid(CMD_fld, 判定対象文字_from + 3,
                                                len(CMD_fld)).find(判定対象文字3)
                                対象文字数 = 判定対象文字_to + 3 + 1
                                # '富士通日本語対応　FROM
                            elif 判定対象文字2 == "C":
                                判定対象文字_to = Mid(CMD_fld, 判定対象文字_from + 3,
                    ...
                    # '        富士通日本語対応 TO
                        ...
                        while True:
                            i2 = i2 + 1
                            if i2 >= len(CMD_fld) or 分離文字判定_COBOL(
                                    Mid(CMD_fld, i2, 1), Mid(
                                        CMD_fld, i2 + 1, 1),
