...
from analysis1_PSB_analysis import analysis1_PED2_analysis
# from analysis2_SCHEMA_analysis import analysis2_SCHEMA_analysis
from analysis2_PCB_analysis import analysis2_SCHEMA_analysis
...
def main(db_path,title,folder_Schema_path,ped_file_path):
    ...
    print("PSB定義解析完了", time.time()-start)
