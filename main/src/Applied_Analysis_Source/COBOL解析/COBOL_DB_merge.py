...
def main(Folder_COBOL_path,title,Limit_Call_Order="True",rem_extensions=True):
    
    print("start to merge COBOL db")
    ...
    write_excel_multi_sheet("COBOL_CMD情報_merge版.xlsx",COBOL_CMD,"COBOL_CMD情報",title,COBOL_CMD_header)
    write_excel_multi_sheet("COBOL_関連資産_merge版.xlsx",COBOL_relate_asset,"COBOL_関連資産",title,COBOL_relate_asset_header)
    write_excel_multi_sheet("COBOL_基本情報_merge版.xlsx",COBOL_basic_info,"COBOL_基本情報",title,COBOL_basic_info_header)
    write_excel_multi_sheet("COBOL_入出力情報1_merge版.xlsx",COBOL_IO_1,"COBOL_入出力情報1",title,COBOL_IO_1_header)
    write_excel_multi_sheet("COBOL_入出力情報2_merge版.xlsx",COBOL_IO_2,"COBOL_入出力情報2",title,COBOL_IO_2_header)
    write_excel_multi_sheet("COBOL_入出力情報3_merge版.xlsx",COBOL_IO_3,"COBOL_入出力情報3",title,COBOL_IO_3_header)
    write_excel_multi_sheet("共通_PGM_IO情報_merge版.xlsx",COMMON_PGM_IO,"共通_PGM_IO情報",title,COMMON_PGM_IO_header)
    write_excel_multi_sheet("共通_資産解析_NG情報_merge版.xlsx",COMMON_ANALYSIS_NG,"共通_資産解析_NG情報",title,COMMON_ANALYSIS_NG_header)
    write_excel_multi_sheet("共通_資産解析_関連情報_merge版.xlsx",COMMON_ANALYSIS_relate,"共通_資産解析_関連情報",title,COMMON_ANALYSIS_relate_header)
    
    print("finish to merge COBOL db")
